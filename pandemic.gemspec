...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/client_test.rb", "test/connection_pool_test.rb", "test/handler_test.rb", "test/mutex_counter_test.rb", "test/server_test.rb", "test/test_helper.rb", "test/util_test.rb"]
